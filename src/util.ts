import { CanvasObjectProperties } from "./canvasObjects/object";
...
export function getRandomCanvasObjectProperties(maxX: number, maxY: number, maxDx: number, maxDy: number): CanvasObjectProperties {
